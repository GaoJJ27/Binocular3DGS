...
def training(dataset, opt, pipe, args):
    ...
    # print("[DEBUG]Training on {} viewpoints".format(len(viewpoint_stack)))
    # print("[DEBUG]viewpoint_stack:", viewpoint_stack)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_iterations", nargs="+", type=int, default=[1000, 5000, 10000, 20000, 30000])
